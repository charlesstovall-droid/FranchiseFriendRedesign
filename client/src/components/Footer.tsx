import { Facebook, Linkedin, Twitter, Mail, Phone, MapPin, Settings, Music, Radio, Youtube, Instagram } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          <div>
            ...
            <div className="flex gap-4">
              <a href="https://www.instagram.com/thefranchisefriend" target="_blank" rel="noopener noreferrer" className="text-primary-foreground/60 hover:text-secondary transition-colors" title="Instagram" data-testid="link-instagram"><Instagram className="w-5 h-5" /></a>
              <a href="https://www.youtube.com/@yourfranchisefriend" target="_blank" rel="noopener noreferrer" className="text-primary-foreground/60 hover:text-secondary transition-colors" title="YouTube" data-testid="link-youtube"><Youtube className="w-5 h-5" /></a>
