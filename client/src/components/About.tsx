      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="flex flex-col md:flex-row gap-12 items-center">
          <div className="w-full md:w-1/2 relative">
            <div className="relative rounded-2xl overflow-hidden shadow-xl border-2 border-secondary/30" style={{ height: "480px" }}>
              <img
                src={charlesPhoto}
          ...
          <div className="w-full md:w-1/2">
            ...
            {/* Issue 6: Pull-quote surfacing the 1→20 story prominently */}
            <div className="mb-6 border-l-4 border-secondary pl-5">
              <p className="font-['Playfair_Display'] text-2xl md:text-3xl font-bold text-primary leading-tight">
                Scaled 1 → 20 franchise units.
              </p>
              <p className="font-['Playfair_Display'] text-xl md:text-2xl font-bold text-secondary mt-1">
                Now I help you skip the mistakes.
              </p>
            </div>

            <div className="space-y-4 text-muted-foreground text-lg leading-relaxed mb-8">
              <p>
                Based in Charleston, SC, Charles brings over 15 years of entrepreneurial experience to the table. From scaling a single location to 20 successful units across multiple states, he understands the grit required to succeed.
              </p>
              <p>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <a href="mailto:charles.stovall@gmail.com">
