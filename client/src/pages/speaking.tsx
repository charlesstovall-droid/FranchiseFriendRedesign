              ...
              <div className="sticky top-10">
                ...
                <div className="border-t border-gray-700 pt-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <a href="https://www.linkedin.com/in/charles-stovall/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-gray-400 hover:text-[#D4AF37] transition-colors text-sm" data-testid="link-linkedin">
                      <Linkedin size={18} />
                      LinkedIn
                      <ExternalLink size={12} className="ml-auto" />
                    </a>
        ...
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          >
            ...
            <div className="mt-12 pt-8 border-t border-gray-700 flex flex-wrap justify-center gap-6">
              ...
              <a href="https://www.linkedin.com/in/charles-stovall/" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-[#D4AF37] transition-colors text-sm flex items-center gap-2">
